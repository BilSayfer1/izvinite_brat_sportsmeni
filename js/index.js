...
function reload(arr, place) {
    ...
    arr.forEach(item => {
        ...
        const rate = getBlock('./icons/dollar.png', item.price);
        const rate2 = getBlock('./icons/star.svg', item.rating.rate);
        const rate3 = getBlock('./icons/box.png', item.rating.count);
